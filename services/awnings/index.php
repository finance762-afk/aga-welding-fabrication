  ...
  <div class="hero-bg">
    <picture>
      ...
      <img src="/assets/images/<?php echo $heroImg; ?>.jpg"
           ...
           sizes="100vw"
           alt="Fabricated steel awning framework loaded for a San Antonio install by AGA Welding & Fabrication"
...
<section class="section" aria-label="Awning FAQs">
  <div class="container">
    <div class="section-head reveal-up">
      ...
      <h2>Common questions about <span class="text-accent">custom steel awnings in San Antonio</span></h2>
    </div>
    <div class="faq-grid">
