  ...
  <div class="container">
    <div class="hero-grid hero-grid--form">
      ...
      <div class="hero-text">
        ...
        <p class="hero-answer">AGA Welding &amp; Fabrication delivers precision structural steel, custom metalwork, and certified MIG, TIG, and stick welding across San Antonio. Our experienced team brings 43 years of proven craftsmanship to every project — from one-off repairs to complete industrial steel packages. Built right, on time, built to last.</p>
