 ...
 * - https://www.ucity.net/ (official city website)
 * - https://en.wikipedia.org/wiki/Universal_City,_Texas
 * - https://planthardiness.ars.usda.gov/ (USDA zone verification)
 *
 * Verified details:
 * - Population: ~21,000
 * - Location: Bexar County, adjacent to Randolph Air Force Base
 * - Elevation: 700-750 ft
 * - USDA zone: 9a
 * - Key features: Pat Booker Road commercial corridor, proximity to Randolph AFB, residential community
 * - Economy: Military-adjacent services, retail along Pat Booker, residential growth
 */

$pageType    = 'city';
$citySlug    = 'universal-city';
$currentPage = 'service-areas';

$pageTitle       = 'Welding & Metal Fabrication in Universal City, TX | ' . $siteName;
$pageDescription = 'Professional welding and metal fabrication serving Universal City, TX. AGA Welding & Fabrication provides structural steel, custom metalwork, and industrial repairs to Universal City businesses near Randolph AFB and along Pat Booker Road.';
$canonicalUrl    = $siteUrl . '/service-areas/universal-city/';
$ogImage         = $siteUrl . '/assets/images/structural-steel-beams.jpg';

/* Hero image + LCP preload (v6.3) */
$heroImg = 'aga-welding-fabrication-shop';
$heroPreload = [
...
$breadcrumbSchema = generateBreadcrumbSchema([
    ...
    ['name' => 'Universal City', 'url' => $canonicalUrl],
]);
...
<!-- ============================ HERO ============================ -->
<section class="hero hero--photo" aria-label="Welding and metal fabrication in Universal City, TX">
  <div class="hero-bg">
    <picture>
      ...
      <img src="/assets/images/<?php echo $heroImg; ?>.jpg"
           ...
           sizes="100vw"
           alt="AGA Welding & Fabrication shop near Universal City, Texas"
  ...
  <div class="container">
    <div class="hero-grid hero-grid--form">
      ...
      <div class="hero-text">
        <span class="eyebrow">Universal City, TX</span>
        <h1 class="hero-title">Welding &amp; Fabrication in <span class="text-accent">Universal City</span></h1>
        <p class="hero-answer">AGA Welding &amp; Fabrication serves Universal City, TX with precision welding and custom metal fabrication — from commercial projects along Pat Booker Road to residential metalwork near Randolph AFB, delivering structural steel and industrial repairs across northeast Bexar County.</p>
      ...
      <div class="hero-form-card">
        <h2 class="hero-form-title">Free estimate in Universal City</h2>
...
<nav class="breadcrumb container" aria-label="Breadcrumb">
  ...
  <span>Universal City</span>
</nav>

<!-- ============================ INTRO + LOCAL CONTEXT ============================ -->
<section class="section">
  <div class="container-narrow">
    <h2>Metal Fabrication Serving Universal City's Military-Adjacent Community</h2>
    <div class="answer-block">
      <p><strong><?php echo $siteName; ?> is a Texas-licensed welding contractor based in San Antonio, serving Universal City and northeast Bexar County with structural steel fabrication, certified welding, and custom metalwork.</strong> Our Gardner Road shop sits 15 minutes from Universal City via FM 78, bringing precision metal fabrication to businesses along Pat Booker Road and residential communities adjacent to Randolph Air Force Base.</p>
    </div>

    <p>Universal City's character — shaped by its proximity to Randolph AFB and the Pat Booker commercial corridor — creates steady demand for welders who handle both commercial-scale structural steel and the detail work residential projects require. AGA Welding & Fabrication brings <?php echo $yearsInBusiness; ?> years of metal-joining experience to that mix, from handrails at multi-family developments to equipment repairs for service contractors working the Pat Booker corridor.</p>

    <p>The terrain here sits in the 700–750 ft elevation range, slightly higher than central San Antonio and Live Oak to the south. Our welders account for local conditions — scheduling outdoor structural work to avoid summer heat peaks, managing cold-steel preheat during winter mornings — to deliver code-compliant joints year-round across the Universal City service area.</p>

    <p>From commercial racks for businesses along Pat Booker to custom metalwork for Universal City homeowners, we fabricate on spec, weld to certified procedures, and deliver on the timeline you need. If your Universal City project demands structural integrity or custom metal precision, AGA Welding & Fabrication has the shop, the welders, and the proximity to handle it.</p>
  </div>
</section>
...
<section class="section bg-secondary">
  ...
  <div class="container">
    <header class="section-header text-center">
      ...
      <h2>Welding &amp; Fabrication <span class="text-accent">Services</span> in Universal City</h2>
      <p class="section-subtitle">From structural steel to custom metalwork, AGA Welding & Fabrication delivers certified welding and precision fabrication across Universal City and northeast Bexar County.</p>
    </header>
  ...
  <div class="container">
    <div class="split">
      <div class="split-text">
        <span class="eyebrow">Why Universal City Trusts AGA Welding</span>
        ...
        <p>Based 15 minutes from Universal City via FM 78, we deliver quality metalwork to businesses along Pat Booker Road and residential developments near Randolph AFB without the markup or scheduling delays of larger metro fabrication shops. You work directly with the welders building your steel — no layers, no confusion.</p>
        <p>When your Universal City project needs structural integrity or custom metal precision, you need a shop that understands the spec and stands behind the weld. That's what AGA Welding & Fabrication delivers.</p>
...
<section class="cta-band" id="estimate">
  ...
  <div class="container">
    <div class="cta-content">
      <h2>Ready to Start Your Universal City Welding Project?</h2>
